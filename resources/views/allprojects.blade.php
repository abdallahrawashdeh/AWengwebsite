...
<header class="shadow">
  <div class="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
    ...
    <nav class="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
      <ul class="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
        <li class="text-gray-600 md:mr-12 hover:text-[#e8bc61]"><a href="/">Home</a></li>
        <li class="text-gray-600 md:mr-12 hover:text-[#e8bc61]"><a href="/allnews">All News</a></li>
        <li class="text-gray-600 md:mr-12 hover:text-[#e8bc61]"><a href="#">Support</a></li>
        <li class="text-gray-600 md:mr-12 hover:text-[#e8bc61]"><a href="/careers">Careers</a></li>
      </ul>
    </nav>
  </div>
